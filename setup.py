#!/usr/bin/env python
"""
Package metadata for registration_app.
"""
import os
import re
import sys
...
VERSION = get_version('registration_app', '__init__.py')
...
setup(
    ...
    url='https://github.com/subodhpoudel12/registration_app',
    packages=find_packages(
        include=['registration_app', 'registration_app.*'],
        exclude=["*tests"],
    ),
    ...
    classifiers=[
     ...
     entry_points={
        "lms.djangoapp": [
            "registration_app = registration_app.apps:RegistrationAppConfig",
        ],
    }
)
