...
"""
custom_registration_app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'registration_app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/subodhpoudel12/registration_app",
...
#
# html_title = 'custom_registration_app v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'registration_app'),
                os.path.join(root_path, 'registration_app/migrations')])
